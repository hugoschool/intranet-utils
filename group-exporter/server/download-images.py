...
print("You can obtain your cookies by simply typing \"document.cookie\" in your JS console and pasting the result here.")
...
for user in users:
    r = requests.get(f"{BASE_URL}/{user}.jpg", headers={
